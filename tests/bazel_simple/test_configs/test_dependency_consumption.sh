#!/bin/bash
# Cross-module dependency consumption test for the bazel_simple project.
# Builds the consumer project (which links the exported static + shared libs and
# headers) and verifies the resulting binaries' architecture, dynamic linker,
# RUNPATH and execution. Expected values come from the shared config table.
set -uo pipefail
...
forge_section "Dependency Consumption Test: bazel_simple"
