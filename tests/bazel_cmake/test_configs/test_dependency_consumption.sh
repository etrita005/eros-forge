#!/bin/bash
# Cross-module dependency consumption test for the bazel_cmake project.
# Builds the consumer project (which links the CMake-exported static + shared
# libs and headers) and verifies the resulting binaries' architecture, dynamic
# linker, RUNPATH and execution.
set -uo pipefail
...
forge_section "Dependency Consumption Test: bazel_cmake"
